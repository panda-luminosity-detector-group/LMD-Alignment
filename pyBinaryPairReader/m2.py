...
def findMatrices():
	...
	misalign = menuSelect(['Select Misalignment:', 'aligned', 'misalignMatrices-SensorsOnly-10', 'misalignMatrices-SensorsOnly-50', 'misalignMatrices-SensorsOnly-100', 'misalignMatrices-SensorsOnly-200'], 1)
